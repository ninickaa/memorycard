...
questions_list = []
questions_list.append(Question('Which is the most famous italian food?','pasta', 'pizza', 'ajvar', 'sandwich'))
questions_list.append(Question('What is your favourite subject?', 'biology', 'astronomy', 'art', 'english'))
questions_list.append(Question('What is your favourite color?', 'pink', 'blue', 'yellow', 'red'))
questions_list.append(Question('What is your favourite city?', 'Milan', 'Bern', 'Strumica', 'Thessaloniki'))
...
def next_question():
    ...
    curr_question = randint(0,len(questions_list)-1)
    print('Statistics\n-Total question: ', window.total,'\n-Right answer: ',window.score)
    q= questions_list[curr_question]
    ask(q)
def click_OK():
